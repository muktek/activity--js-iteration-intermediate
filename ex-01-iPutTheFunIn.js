 ...
 *        iPutTheFunIn('period') => per~!FUN!~iod
 *
...
var output3 = iPutTheFunIn("yoohoo")
var output4 = iPutTheFunIn("this is a very serious issue")
var output5 = iPutTheFunIn("X")

console.assert(output1 === "bl~!FUN!~ue")
console.assert(output2 === "cod~!FUN!~ings") //HINT: Math.floor(«decimal-value») for rounding down
console.assert(output3 === "yoo~!FUN!~hoo") //HINT: Math.floor(«decimal-value») for rounding down
